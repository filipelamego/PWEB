module.exports = function () {
    ...
    this.salvarProfessor = function (professor, connection, callback) {
        connection.query(`INSERT INTO dbo.professores (NOME_PROFESSOR,EMAIL_PROFESSOR) VALUES
             ('${professor.nome_professor}','${professor.email_professor}')`, callback);
    }
    ...
    this.editarProfessor = function (professor, connection, callback) {
        connection.query(`UPDATE professores SET NOME_PROFESSOR = '${professor.nome_professor}',
             EMAIL_PROFESSOR = '${professor.email_professor}'  WHERE ID_PROFESSOR=${professor.id_professor} `, callback);
    }
